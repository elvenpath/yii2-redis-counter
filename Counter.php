...
class Counter extends Component
{
     ...
     *     [[Connection]]. This can also be an array that is used to create a redis [[Connection]] instance in case you
     *     do not want do configure redis connection as an application component. After the Cache object is created, if
     *     you want to change this property, you should only assign it with a Redis [[Connection]] object.
     */
    public $redis = 'redis';
     ...
     *
     * @return boolean true if a value exists in counter store, false if the value is not in the counter store or
     *     expired.
     */
    ...
    /**
     * Gets the counters identified by keys
     *
     * @param array $keys the keys identifying the counters.
     *
     * @return array counters identified by keys
     */
    public function multiget($keys)
    {
        return $this->redis->executeCommand('MGET', [$keys]);
    }
